...
public class ProductoDTO implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 73 * hash + this.id_pro;
        hash = 73 * hash + Objects.hashCode(this.nombre_pro);
        hash = 73 * hash + Objects.hashCode(this.descripcion_pro);
        hash = 73 * hash + this.unidades_pro;
        hash = 73 * hash + this.valor_pro;
        return hash;
    }
    ...
    public String toString() {
        return "id_pro " + id_pro + ", nombre_pro " + nombre_pro + ", valor_pro " + valor_pro;
    }
